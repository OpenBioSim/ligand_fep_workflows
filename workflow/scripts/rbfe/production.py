...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of neighbouring lambda windows for energy evaluation (SOMD2 only). "
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Enable the long-range LJ dispersion correction (SOMD2 only, default: disabled).",
    )
    parser.add_argument(
        "--runner",
        type=str,
